		...
		<Transition className="grid px-4 py-8 md:py-46 md:px-36 md:grid-cols-2 md:gap-28">
			<div className="max-w-xl mb-7">
				...
				<h2 className="my-4 text-3xl font-semibold">
					Promociona tu vivienda para alquilarla o venderla al mejor
					precio
				</h2>
				<p className="mb-10 mt-7">
					Lorem ipsum dolor sit amet, consectetur adipiscing elit.
					Donec sit amet dapibus quam, consectetur efficitur neque. Ut
					rhoncus, felis eget tristique molestie, sapien arcu blandit
					enim.
				</p>
			</div>
